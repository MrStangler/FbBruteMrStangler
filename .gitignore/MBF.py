...
if platform.python_version().split('.')[0] != '2':
	tampil('\rm[!] Welcom To MBF Versi Mr.Stangler 
	kamu menggunakan python versi %s silahkan menggunakan versi 2.x.x'%v().split(' ')[0])
	os.sys.exit()
...
\rk###########################################################
#             \rb*MULTY BRUTEFORCE FACEBOOK versi Mr.Stangler*\rk                 #
# \rhBY\rp                                             STIC Offcilal \rk#
# \rhGroup WA\rp  https://chat.whatsapp.com/FWYpXuVM65z0diuvmdsl7i \rk#
